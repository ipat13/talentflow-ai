  ...
  return (
    <div className="min-h-screen bg-[#F7FFF7] text-[#2C3E50] font-sans font-inter">
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-[#F7FFF795] backdrop-blur-md">
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center">
              <button className="inline-flex items-center justify-center rounded-lg px-4 py-2 text-sm font-medium bg-[#006EB8] text-[#F7FFF7] hover:bg-[#005A9C] transition-colors">
                Request Demo
              </button>
            </div>
          </div>
      ...
      <section className="relative overflow-hidden">
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <button className="inline-flex items-center justify-center rounded-lg px-8 py-3 text-base font-medium bg-[#006EB8] text-[#F7FFF7] hover:bg-[#005A9C] transition-colors">
                Request Demo
              </button>
      ...
      <section id="features" className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {/* Feature 1 */}
          <div className="rounded-xl border border-[#006EB830] bg-white p-6 shadow-sm">
            <div className="mb-6">
              <span className="text-4xl">🤖</span>
            </div>
            <h3 className="mt-4 text-xl font-bold">AI-Powered Interviews</h3>
          ...
          <div className="rounded-xl border border-[#006EB830] bg-white p-6 shadow-sm">
            ...
            <h3 className="mt-4 text-xl font-bold">Comprehensive Evaluation</h3>
            <p className="mt-2 text-[#95A5A6]">
          ...
          <div className="rounded-xl border border-[#006EB830] bg-white p-6 shadow-sm">
            ...
            <h3 className="mt-4 text-xl font-bold">Time-Saving Efficiency</h3>
            <p className="mt-2 text-[#95A5A6]">
          ...
          <div className="rounded-xl border border-[#006EB830] bg-white p-6 shadow-sm">
            ...
            <h3 className="mt-4 text-xl font-bold">Data-Driven Insights</h3>
            <p className="mt-2 text-[#95A5A6]">
          ...
          <div className="rounded-xl border border-[#006EB830] bg-white p-6 shadow-sm">
            ...
            <h3 className="mt-4 text-xl font-bold">Customizable Assessments</h3>
            <p className="mt-2 text-[#95A5A6]">
          ...
          <div className="rounded-xl border border-[#006EB830] bg-white p-6 shadow-sm">
            ...
            <h3 className="mt-4 text-xl font-bold">Collaborative Hiring</h3>
            <p className="mt-2 text-[#95A5A6]">
      ...
      <section className="border-t">
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-24">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6">Cut Your Hiring Cost and Timespan</h2>
        ...
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-24">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6">Conduct Fair and Consistent Technical Interviews</h2>
              <p className="text-lg text-[#95A5A6] mb-8">
        ...
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-24">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6">Make Data-Driven Hiring Decisions</h2>
              <p className="text-lg text-[#95A5A6] mb-8">
      ...
      <section id="how-it-works" className="border-t">
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-24">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6">See TalentsFlow.ai in Action</h2>
      ...
      <section id="pricing" className="py-24 bg-[#45B7D110]">
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center mb-16">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6">Pricing</h2>
          ...
          <div className="mx-auto max-w-md">
            <div className="rounded-xl border border-[#006EB830] bg-white p-8 shadow-sm">
              <div className="text-center mb-8">
                <div className="text-4xl font-bold mb-2 text-[#2C3E50]">CA$599 / month</div>
              ...
              <button className="w-full inline-flex items-center justify-center rounded-lg px-8 py-3 text-base font-medium bg-[#006EB8] text-[#F7FFF7] hover:bg-[#005A9C] transition-colors">
                Start Free Trial
              </button>
            </div>
          </div>
      ...
      {/* Final CTA */}
      <section className="border-t bg-[#4ECDC410]">
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-24">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-6">Ready to Transform Your Tech Hiring?</h2>
            <p className="text-lg text-[#95A5A6] mb-10">
      ...
      {/* Footer */}
      <footer className="border-t bg-[#F7FFF7]">
        <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              <h4 className="font-semibold mb-4 text-[#2C3E50]">Product</h4>
            ...
            <div>
              <h4 className="font-semibold mb-4 text-[#2C3E50]">Company</h4>
              <ul className="space-y-2 text-[#95A5A6]">
                <li>About</li>
                <li>Blog</li>
                <li>Careers</li>
            ...
            <div>
              <h4 className="font-semibold mb-4 text-[#2C3E50]">Resources</h4>
              <ul className="space-y-2 text-[#95A5A6]">
                <li>Support</li>
                <li>Documentation</li>
                <li>Case Studies</li>
