...
import { Button, Card, CardContent, CardHeader, CardTitle, Badge, Input, Textarea, Modal } from "@/components/ui";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800/50 to-slate-900 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <Modal isOpen={showDeleteModal} onClose={() => setShowDeleteModal(false)} title="Confirmar Eliminação">
          <div className="space-y-4">
            <p className="text-slate-300">
              Tens a certeza que queres eliminar a vaga <strong className="text-white">{job?.title}</strong>?
            </p>
            <p className="text-slate-400 text-sm">Esta ação não pode ser desfeita. Todos os candidatos associados a esta vaga serão removidos.</p>
